  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        ...
        {/* Title + button */}
<article
  className={`relative p-4 transition-opacity duration-700 ease-in-out ${
...
>
  <div className="relative z-10 flex justify-center">
    <button
      ...
      className="px-6 py-3 bg-white text-black rounded-xl shadow hover:shadow-xl transition font-medium"
    >
      {button}
    </button>
  </div>
