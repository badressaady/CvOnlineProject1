  ...
  return (
    <div className="flex h-full relative border border-1">
      ...
      {templateSettings.showPhoto && (
        <div
          id="picture"
          className="absolute top-6 right-10 rounded-full h-25 w-25 border border-1"
      ...
      <div
        ...
        style={{
          backgroundColor: templateSettings.backgroundColor || defaultBackgroundColor
        }}
      >
        {/* SUMMARY */}
        <h3
        ...
        <p
          className="text-[11px] mb-6 whitespace-pre-line"
          style={{ color: templateSettings.inputColor || defaultInputColor }}
        >
          ...
          >
            {education.map((edu, i) => (
              <div key={edu.id || i}>
                ...
                <br />
                {edu.description && <p className="whitespace-pre-line mt-1">{edu.description}</p>}
              </div>
            ))}
          </div>
        ) : (
