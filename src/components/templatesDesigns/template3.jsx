...
export default function Template3() {
  const { cvData, templateSettings } = useCv();
  ...
  return (
    <div className="flex h-full relative border border-1">
      ...
      >
        <h2
          className="font-bold text-xl break-words mr-[10px]"
        ...
        <p
          className="text-[12px] whitespace-pre-line break-words mr-[10px]"
          style={{ color: templateSettings.titleColor || defaultTitleColor }}
        >
      ...
      >
        ...
        {experience.length > 0 ? (
          ...
          <p className="text-[11px]">Aucune expérience ajoutée</p>
        )}
        ...
        {education.length > 0 ? (
          ...
          <p className="text-[11px]">Aucune éducation ajoutée</p>
        )}
      </div>
      ...
      >
        ...
        {languages.length > 0 ? (
          ...
          <p className="text-[11px]">Aucune langue ajoutée</p>
        )}
        ...
        {skills.length > 0 ? (
          ...
          <p className="text-[11px]">Aucune compétence ajoutée</p>
        )}
      </div>
    </div>
  );
